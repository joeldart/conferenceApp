...
(function (window, undefined) {
    ...
    (function () {
		...
		if(options['afterRenderAll'])
		    options['afterRenderAll'](targetNode, arrayOrObservableArray);			    
        ...
        ko.bindingHandlers['template'] = {
            'update': function (element, valueAccessor, allBindingsAccessor, viewModel) {
                ...
                if (typeof bindingValue['foreach'] != "undefined") {
                    ...
                    templateSubscription = ko.renderTemplateForEach(templateName, bindingValue['foreach'] || [], { 'templateOptions': bindingValue['templateOptions'], 'afterAdd': bindingValue['afterAdd'], 'beforeRemove': bindingValue['beforeRemove'], 'includeDestroyed': bindingValue['includeDestroyed'], 'afterRender': bindingValue['afterRender'], 'insertAfter': bindingValue['insertAfter'], 'afterRenderAll': bindingValue['afterRenderAll'] }, element);
		}
                else {
